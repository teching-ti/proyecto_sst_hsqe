...
$listadoPersonalAdministrativo = $trabajadoresController->mostrarPersonalAdministrativo();
?>
        ...
        <thead>
            <tr>
                ...
                <th class="th-datos-personales">Fecha Cese</th>
                ...
                <?php if (!empty($listadoPersonalAdministrativo)): ?>
                    <?php foreach (array_keys($listadoPersonalAdministrativo[0]) as $col): ?>
                        <?php if (!in_array($col, ['activo', 'apellidos', 'nombres', 'id', 'fecha_ingreso', 'fecha_cese', 'cargo', 'area', 'departamento', 'celular', 'correo', 'tipo_contrato', 'sede', 'modalidad', 'estado', 'telefono'])): ?>
        ...
        <tbody id="tableBody">
            <?php
                $contador = 1;
                //print_r($listadoPersonalAdministrativo);
                foreach ($listadoPersonalAdministrativo as $trabajador): ?>
                <tr data-id="<?= $trabajador['id'];?>">
                    ...
                    <?php if (!in_array($col, ['activo', 'apellidos', 'nombres', 'id', 'fecha_ingreso', 'fecha_cese', 'cargo', 'area', 'departamento', 'celular', 'correo', 'tipo_contrato', 'estado', 'telefono', 'sede', 'modalidad'])): ?>
                        <?php 
    ...
    <div id="modal-archivo" class="modal-oculto">
        <form id="form-adjuntar-archivo" enctype="multipart/form-data" class="modal-content">
            ...
            <div class="modal-botones">
                <button type="submit" id="btn-guardar" class="btn">Guardar</button>
    ...
    <button id="btn-mostrar-documentos" class="btn-mostrar-documentos">
        ...
        <!-- Funcionalidad en base a esquema de enrutamiento -->
</main>
